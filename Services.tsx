            ...
            <motion.div key={service.id} variants={fadeUp} custom={i}>
              <Link href={service.slug}>
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-2xl cursor-pointer border border-slate-200 hover:border-[#394696]/40 transition-colors"
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-slate-600 mb-4 leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>{service.description}</p>
                    <div className="flex flex-wrap gap-2 mb-4">
                      {service.features.slice(0, 3).map((f) => (
                        <span key={f} className="text-xs px-2.5 py-1 rounded-full text-slate-600 border border-slate-200" style={{ fontFamily: 'Figtree, sans-serif', fontWeight: 600 }}>
                          {f}
                        </span>
                      ))}
