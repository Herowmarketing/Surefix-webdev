...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6"
      ...
      <p className="text-slate-500 text-center max-w-sm mb-8" style={{ fontFamily: 'Georgia, serif' }}>
      ...
      <div className="flex gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-bold text-sm uppercase tracking-wide text-slate-700 hover:text-slate-900 transition-all duration-200"
